...
public class BlackJackServiceImpV2 implements BlackJackService {
	...
	public BlackJackServiceImpV2() {
		alist = new ArrayList<String>(); // 스페이드 A : 1, 스페이드 2 : 2
		blist = new ArrayList<Integer>(); // 카드 점수만 모은 리스트(1점, 2점, 3점, ...)
		clist = new ArrayList<String>(); // 카드 종류와 번호를 모은 리스트(스페이드 A, 스페이드 2, ...)
